...
def distance_constraint(particle1, particle2, constraint_distance):
    current_distance = distance(particle1.px, particle1.py, particle2.px, particle2.py)
    error_factor = (current_distance - constraint_distance) / current_distance if current_distance != 0 else 0
    correction_x1 = 0.5 * error_factor * (particle2.px - particle1.px)
    correction_y1 = 0.5 * error_factor * (particle2.py - particle1.py)
